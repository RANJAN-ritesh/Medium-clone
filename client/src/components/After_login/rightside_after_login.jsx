...
import { Blogs_after_login } from "./Blogs_after_login";
import { Searchtag } from "../../reduxStore/action";
    ...
    <div className="right_side">
      ...
      <div className="connect_with_us">
        ...
        <div className="connect_div_3">
          <div>
            <a
              href="https://twitter.com/mediumsupport"
      ...
      <div className="reading_list">
        ...
        <p className="reading_list_p_2">
          ...
          on any story to easily add it to your <br /> reading list or a custom
